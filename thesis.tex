...
%\usepackage{caption}
\usepackage{bm}
\usepackage[usenames,dvipsnames,svgnames,table]{xcolor} % use color % easier math formulae, align, subequations \ldots
...
\noindent This is to certify that the thesis titled {\bf TITLE OF THESIS}, submitted by {\bf NAME}, 
